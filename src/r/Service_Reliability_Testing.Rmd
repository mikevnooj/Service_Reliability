...
date: '`r gsub(" 0", " ", format(as.Date("2020-10-12"), "%B %d, %Y"))`' # crtl+f and change all dates for past reports. Be sure to change second yesterday_Avail variable.
knit: (function(inputFile, encoding) { rmarkdown::render(inputFile, encoding = encoding, output_file = paste0(format(as.Date("2020-10-12"), "%Y%m%d"), " Service Reliability Testing",'.html'));rmarkdown::render(inputFile, encoding = encoding, output_file = paste0(format(as.Date("2020-10-12"), "%Y%m%d"), " Service Reliability Testing",'.html'),output_dir = "//iptc-prtsvr1/shared/Transportation Management/Service Reliability Reports")})
output:
  html_document:
    df_print: paged
    fig_cap: true
...
# 
yesterday_Avail <- as.Date("2020-10-12") - 1 # switch this for past date.
...
If you believe this report is in error, please contact Mike Nugent (michael.nugent@indygo.net). Report last revised 2020-10-12.