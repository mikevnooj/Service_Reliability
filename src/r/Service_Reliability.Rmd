...
# );rmarkdown::render(inputFile,encoding = encoding,output_file = paste0(format(Sys.Date(), "%Y%m%d"), " # Service Reliability Report", '.html'))})
...
# # 
# yesterday_Avail <- as.Date("2020-02-12") - 1 # switch this for past date.
# 
...
If you believe this report is in error, please contact Mike Nugent (michael.nugent@indygo.net). Report last revised 2020-08-21.